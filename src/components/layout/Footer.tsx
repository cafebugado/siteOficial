        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 md:gap-10">
          <div className="hidden md:block col-span-1 md:col-span-1 space-y-4">
            ...
            <div className="hidden md:flex space-x-4">
              ...
              <a href="https://discord.gg/FkDb6PxH" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-cb-purple dark:text-gray-400 dark:hover:text-cb-purple transition-colors">
